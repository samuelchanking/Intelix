...
namespace App4.Views
{
    public partial class Page2 : ContentPage, INotifyPropertyChanged
    {
        ...
        protected override void OnAppearing()
        {
            ...
            while (reader.Read())
            {
                scoresList.Add(reader.GetInt32("Amount"));
            ...
            double mean = scoresList.Average();
            double stdDev = Math.Sqrt(scoresList.Average(v => Math.Pow(v - mean, 2)));
            ...
            //listviewdemo1.ItemsSource = clientlist;
        }
